...
import os
TEST_NUM_MOSAIC_DOMAINS = int(os.environ["TEST_NUM_MOSAIC_DOMAINS"])
...
def channel_pixels(wavelength_A,flux,N,UMAT_nm,Amatrix_rot,fmodel_generator,local_data):
  ...
  SIM.mosaic_domains = TEST_NUM_MOSAIC_DOMAINS  # 77 seconds.  With 100 energy points, 7700 seconds (2 hours) per image
